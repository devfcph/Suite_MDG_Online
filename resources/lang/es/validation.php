...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'inputSesion' => 'Sesión',
        'inputDivisa' => 'Divisa',
        'inputOperacion' => 'Tipo de Operación',
        'inputExpiracion' => 'Expiración',
        'inputPeriodoVela' => 'Periodo de velas',
        'inputInversion' => 'Inversión',
        'inputRendimiento' => 'Rendimiento',
        'inputResultado' => 'Resultado',

        //OTROR
        "capturaTrade" => "Imagen de Operación",
        "inputSYR" => "Soportes y Resistencias",
        "inputBB" => "Bandas de Bollinger",
        "inputConfirmacionAO" => "Confirmación AO",
        "inputPosicionAO" => "Posición AO",
        "inputEstocastico" => "Estocástico",
        "inputCruceEstocastico" => "Cruce de Estocástico",
        "inputPatronVela" => "Nivel de Patrón de Vela",
        "inputVolatilidad" => "Volatilidad",
        "inputTendencia" => "Tendencia",
        "inputEmociones" => "Emociones",
        "inputAccion" => "Acciones After Trade",
        "inputAprendizaje" => "Mi Aprendizaje",
    ],
